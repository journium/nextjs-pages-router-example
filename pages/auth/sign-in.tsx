...
export default function SignInPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Redirect based on whether user has habits
      if (habits.length === 0) {
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>Sign in to your Looply account</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Button variant="outline" type="button" className="w-full bg-transparent cursor-pointer" onClick={handleGoogleSignIn}>
